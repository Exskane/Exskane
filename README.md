...
### Backend  
`PHP (Laravel)` • `Node.js (Express)` • `REST API` • `GraphQL`   
...
- **Digital Wedding Book**  
  A collaborative project for creating a digital wedding book. It includes features such as online wedding invitations, guest attendance tracking, financial records (income & expenses), and interactive event details.  
  _Tech stack:_ Laravel, Blade, MySQL, Bootstrap, JavaScript.  
